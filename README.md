...
Through the development of a Flutter based mobile and a ASP.NET Web application, both of which will be integrated to a Supabase database. The system will enable the teacher to upload and update the marks on the web app and for the parents to access them through the mobile application. 
